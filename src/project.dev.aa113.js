window.__require = function e(t, n, r) {
  ...
  PokerRoot: [ function(require, module, exports) {
    ...
    var PokerRoot = function(_super) {
      ...
      PokerRoot.prototype.onAddChild = function(child) {
        ...
        } else this.setTotalValue(poker.getValue());
        poker.setRecycle(true);
      };
      PokerRoot.prototype.setTotalValue = function(value) {
        this.totalValue0 += value;
        1 == value ? this.totalValue1 += this.totalValue0 + 10 : 0 != this.totalValue1 && (this.totalValue1 += value);
        this.totalValue1 > 21 && (this.totalValue1 = 0);
        this.totalValue0 > 21 ? this.boom() : 21 == this.totalValue0 || 21 == this.totalValue1 ? this.complete() : this.node.childrenCount >= 5 ? this.overFive() : Game_1.Game.clearStreak();
        console.log(" key:", this.node.name, ", value0:", this.totalValue0, ", value1:", this.totalValue1);
        this.updateValueLabel();
      };
      PokerRoot.prototype.updateValueLabel = function() {
        if (0 == this.totalValue1) {
          this.MutilpValueNode.active = false;
          this.SingleValueNode.active = true;
        } else {
      ...
      PokerRoot.prototype.boom = function() {
        console.log(" \u8d85\u8fc721\u70b9\u7206\u6389");
      ...
      PokerRoot.prototype.complete = function() {
        console.log(" \u5b8c\u6210 21\u70b9");
        ...
        Game_1.Game.clearStep();
        Game_1.Game.getStreak() >= 2 && Game_1.Game.addScore(100 * Game_1.Game.getStreak(), CMath.ConvertToNodeSpaceAR(this.node, Game_1.Game.removeNode));
      };
      PokerRoot.prototype.overFive = function() {
        console.log(" \u8d85\u8fc75\u5f20 ");
        this.flyALLChildren(true);
        this.totalValue0 = 0;
        this.totalValue1 = 0;
      ...
      PokerRoot.prototype.flyALLChildren = function(isAddScore) {
        ...
        for (var _i = 0, children_1 = children; _i < children_1.length; _i++) {
          ...
          var poker = child.getComponent(Poker_1.default);
          poker.autoCompleteDone(.05 * count, count % 2 ? 1 : -1, isAddScore, zIndex++);
          count--;
        }
      };
  ...
  Poker: [ function(require, module, exports) {
    ...
    var Poker = function(_super) {
      ...
      Poker.prototype.autoCompleteDone = function(delay, dir, isAddScore, zIndex) {
        var _this = this;
        ...
        this.scheduleOnce(function() {
          ...
          _this.node.runAction(cc.sequence(cc.delayTime(delay), cc.callFunc(function() {
            ...
            isAddScore && Game_1.Game.addScore(score, scorePos);
          ...
          }, _this), cc.sequence(cc.repeat(cc.spawn(cc.moveBy(.01, 1.5 * dir + offsetX, 15).easing(cc.easeQuinticActionOut()), cc.rotateBy(.01, 20 * dir).easing(cc.easeQuadraticActionIn())), 30), cc.repeat(cc.spawn(cc.moveBy(.01, 2 * dir + offsetX, -20).easing(cc.easeQuinticActionIn()), cc.rotateBy(.01, 20 * dir).easing(cc.easeQuadraticActionIn())), 180), cc.callFunc(function() {
            console.log("done!");
      ...
      Poker.prototype.setCardState = function(state, canMove) {
        ...
        this.isWildCard() && this.canMove && this.RecycleAnimation.play();
