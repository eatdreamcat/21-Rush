window.__require = function e(t, n, r) {
  ...
  EventName: [ function(require, module, exports) {
    ...
    (function(GlobalEvent) {
      ...
      GlobalEvent[GlobalEvent["BUST"] = 9] = "BUST";
      GlobalEvent[GlobalEvent["COMPLETE_21"] = 10] = "COMPLETE_21";
      GlobalEvent[GlobalEvent["OVER_FIVE_CARDS"] = 11] = "OVER_FIVE_CARDS";
      GlobalEvent[GlobalEvent["COMBO"] = 12] = "COMBO";
      GlobalEvent[GlobalEvent["SUPER_COMBO"] = 13] = "SUPER_COMBO";
      GlobalEvent[GlobalEvent["WILD"] = 14] = "WILD";
      GlobalEvent[GlobalEvent["NO_BUST"] = 15] = "NO_BUST";
      GlobalEvent[GlobalEvent["CHECK_COMPLETE"] = 16] = "CHECK_COMPLETE";
      GlobalEvent[GlobalEvent["PLAY_RECYCLE_POKERS"] = 17] = "PLAY_RECYCLE_POKERS";
      GlobalEvent[GlobalEvent["DEV_POKERS"] = 18] = "DEV_POKERS";
      GlobalEvent[GlobalEvent["PLAY_POKER_PLACE"] = 19] = "PLAY_POKER_PLACE";
      GlobalEvent[GlobalEvent["PLAY_POKER_FLY"] = 20] = "PLAY_POKER_FLY";
      GlobalEvent[GlobalEvent["PLAY_OVER_1"] = 21] = "PLAY_OVER_1";
      GlobalEvent[GlobalEvent["PLAY_OVER_2"] = 22] = "PLAY_OVER_2";
      GlobalEvent[GlobalEvent["PLAY_PAUSE"] = 23] = "PLAY_PAUSE";
      GlobalEvent[GlobalEvent["PLAY_START"] = 24] = "PLAY_START";
      GlobalEvent[GlobalEvent["PLAY_SHAKE"] = 25] = "PLAY_SHAKE";
      GlobalEvent[GlobalEvent["SMALL_BGM"] = 26] = "SMALL_BGM";
      GlobalEvent[GlobalEvent["NORMAL_BGM"] = 27] = "NORMAL_BGM";
      GlobalEvent[GlobalEvent["PLAY_RECYCLE"] = 28] = "PLAY_RECYCLE";
    ...
    var GameScene = function(_super) {
      ...
      GameScene.prototype.onLoad = function() {
        ...
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.UPDATE_RECYCLE_POKER, function(count) {
          ...
          if (count < 2 && count >= 1) _this.Bust01.getChildByName("Cover").active = true; else if (count < 3) {
            _this.Bust01.getChildByName("Cover").active = true;
            _this.Bust02.getChildByName("Cover").active = true;
          } else {
            _this.Bust01.getChildByName("Cover").active = true;
            _this.Bust02.getChildByName("Cover").active = true;
            _this.Bust03.getChildByName("Cover").active = true;
          }
        }, this);
        ...
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.BUST, function(index) {
          ...
          var node = GameFactory_1.gFactory.getSpecialFont(spriteFrame, cc.v2(pos.x, pos.y + 200), function() {
            bgNode.stopAllActions();
            bgNode.scaleY = 0;
            bgNode.runAction(cc.sequence(cc.fadeIn(0), cc.scaleTo(.1, 1, 1), cc.fadeOut(.2)));
          });
        ...
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.OVER_FIVE_CARDS, function(index) {
          ...
          var node = GameFactory_1.gFactory.getSpecialFont(spriteFrame, cc.v2(pos.x, pos.y + Pokers_1.ADD_SCORE_SPECILA_OFFSET_Y), function() {
            ...
            scoreBg.runAction(cc.sequence(cc.moveTo(0, 0, -800), cc.moveTo(Pokers_1.NORMAL_SCORE_MOVE_TIME, 0, 175)));
          });
          _this.RemoveNode.addChild(node);
        }, this);
      ...
      GameScene.prototype.onSelectPokerAddChild = function(child) {
        ...
        Game_1.Game.setCurSelectPoker(poker);
      };
  ...
  Game: [ function(require, module, exports) {
    ...
    var GameMgr = function() {
      ...
      GameMgr.prototype.getCurSelectPoker = function() {
        this.curSelectPoker || console.error(" cur select poker is null");
        return this.curSelectPoker;
      };
      GameMgr.prototype.setCurSelectPoker = function(poker) {
        null == poker;
      ...
      GameMgr.prototype.calTimeBonus = function() {
        ...
        this.timeBonus = (this.flipCounts / Pokers_1.TOTAL_POKER_COUNT * 2.4 + .3) * this.gameTime;
      ...
      GameMgr.prototype.addRemovePokerCount = function(count) {
        ...
        if (this.removePokerCount == Pokers_1.TOTAL_POKER_COUNT) {
  ...
  PokerRoot: [ function(require, module, exports) {
    ...
    var PokerRoot = function(_super) {
      ...
      PokerRoot.prototype.onTouchStart = function(e) {
        ...
        Game_1.Game.setCurSelectPoker(null);
        ...
        var addScore = this.checkAddScore(curSelectPoker.isWildCard());
        console.error(" on touch start add score:", addScore);
        Game_1.Game.addStep([ curSelectPoker.node ], [ oldParent ], [ lastPos ], [], [ -addScore ], [ CMath.ConvertToNodeSpaceAR(this.node, Game_1.Game.removeNode) ]);
      };
      ...
      PokerRoot.prototype.setTotalValue = function(value, isWild, isCheck, count, isEnd) {
        ...
        if (1 == value) {
          totalValue0_test + 10 == Pokers_1.TARGET_POINT && (totalValue0_test = Pokers_1.TARGET_POINT);
          totalValue1_test != Pokers_1.TARGET_POINT && (totalValue1_test += 10);
        }
        ...
        } else count >= 5 ? addScore += this.overFive(isCheck) : isCheck || this.scheduleOnce(function() {
      ...
      PokerRoot.prototype.checkAddScore = function(isWild) {
        ...
        var totalValue0_test = this.totalValue0;
        var totalValue1_test = this.totalValue1;
        if (totalValue0_test > Pokers_1.TARGET_POINT) ; else if (totalValue0_test == Pokers_1.TARGET_POINT || totalValue1_test == Pokers_1.TARGET_POINT) {
      ...
      PokerRoot.prototype.completeFly = function() {
        this.flyCount++;
        this.flyCount >= this.totalFlyCount && (this.canTouch = true);
      };
  ...
  Pokers: [ function(require, module, exports) {
    ...
    exports.Pokers = [ "spade_,1", "diamond_,9", "heart_,10", "heart_,1", "club_,1", "diamond_,1", "spade_,9", "heart_,9", "club_,9", "diamond_,10", "spade_,10", "spade_,2", "heart_,2", "club_,2", "diamond_,2", "spade_,3", "heart_,3", "club_,3", "diamond_,3", "spade_,4", "heart_,4", "club_,4", "diamond_,4", "spade_,5", "heart_,5", "club_,5", "diamond_,5", "spade_,6", "heart_,6", "club_,6", "diamond_,6", "spade_,7", "heart_,7", "club_,7", "diamond_,7", "spade_,8", "heart_,8", "club_,8", "diamond_,8", "club_,10", "spade_,11", "heart_,11", "club_,11", "diamond_,11", "spade_,12", "heart_,12", "club_,12", "diamond_,12", "spade_,13", "heart_,13", "club_,13", "diamond_,13" ];
    ...
    var Poker = function(_super) {
      ...
      Poker.prototype.autoCompleteDone = function(delay, dir, zIndex, isBoom, callback) {
        ...
        this.scheduleOnce(function() {
          ...
          _this.node.setParent(Game_1.Game.removeCardNode);
        ...
        this.scheduleOnce(function() {
          ...
          }, _this), cc.sequence(cc.repeat(cc.spawn(cc.moveBy(.01, 3 * dir + offsetX, 15).easing(cc.easeQuinticActionOut()), cc.rotateBy(.01, 20 * dir).easing(cc.easeQuadraticActionIn())), 30), cc.repeat(cc.spawn(cc.moveBy(.01, 2 * dir + offsetX, -20).easing(cc.easeQuinticActionIn()), cc.rotateBy(.01, 20 * dir).easing(cc.easeQuadraticActionIn())), 180), cc.callFunc(function() {
            console.log("done!");
      ...
      Poker.prototype.shake = function() {
        if (this.isCycled()) return;
        if ([ "0", "1", "2", "3", "RemoveCardNode" ].indexOf(this.node.parent.name) >= 0) return;
      ...
      Poker.prototype.onSetParent = function(parent) {
        if ("RemoveCardNode" == parent.name) this.setComplete(true); else {
  ...
  SpecialFont: [ function(require, module, exports) {
    ...
    var SpecialFont = function(_super) {
      ...
      SpecialFont.prototype.reuse = function() {
        ...
        this.callback && this.callback();
        this.node.runAction(cc.sequence(cc.fadeIn(0), cc.scaleTo(.2, 1.2), cc.scaleTo(.1, .9), cc.scaleTo(.1, 1.1), cc.scaleTo(.1, 1), cc.delayTime(.1), cc.fadeOut(.1), cc.callFunc(function() {
