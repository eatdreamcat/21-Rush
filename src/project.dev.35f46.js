window.__require = function e(t, n, r) {
  ...
  EventName: [ function(require, module, exports) {
    ...
    (function(GlobalEvent) {
      ...
      GlobalEvent[GlobalEvent["BUST"] = 10] = "BUST";
      GlobalEvent[GlobalEvent["COMPLETE_21"] = 11] = "COMPLETE_21";
      GlobalEvent[GlobalEvent["OVER_FIVE_CARDS"] = 12] = "OVER_FIVE_CARDS";
      GlobalEvent[GlobalEvent["COMBO"] = 13] = "COMBO";
      GlobalEvent[GlobalEvent["SUPER_COMBO"] = 14] = "SUPER_COMBO";
      GlobalEvent[GlobalEvent["WILD"] = 15] = "WILD";
      GlobalEvent[GlobalEvent["NO_BUST"] = 16] = "NO_BUST";
      GlobalEvent[GlobalEvent["CHECK_COMPLETE"] = 17] = "CHECK_COMPLETE";
      GlobalEvent[GlobalEvent["PLAY_RECYCLE_POKERS"] = 18] = "PLAY_RECYCLE_POKERS";
      GlobalEvent[GlobalEvent["DEV_POKERS"] = 19] = "DEV_POKERS";
      GlobalEvent[GlobalEvent["PLAY_POKER_PLACE"] = 20] = "PLAY_POKER_PLACE";
      GlobalEvent[GlobalEvent["PLAY_POKER_FLY"] = 21] = "PLAY_POKER_FLY";
      GlobalEvent[GlobalEvent["PLAY_OVER_1"] = 22] = "PLAY_OVER_1";
      GlobalEvent[GlobalEvent["PLAY_OVER_2"] = 23] = "PLAY_OVER_2";
      GlobalEvent[GlobalEvent["PLAY_PAUSE"] = 24] = "PLAY_PAUSE";
      GlobalEvent[GlobalEvent["PLAY_START"] = 25] = "PLAY_START";
      GlobalEvent[GlobalEvent["PLAY_SHAKE"] = 26] = "PLAY_SHAKE";
      GlobalEvent[GlobalEvent["SMALL_BGM"] = 27] = "SMALL_BGM";
      GlobalEvent[GlobalEvent["NORMAL_BGM"] = 28] = "NORMAL_BGM";
      GlobalEvent[GlobalEvent["PLAY_RECYCLE"] = 29] = "PLAY_RECYCLE";
  ...
  GameScene: [ function(require, module, exports) {
    ...
    var GameScene = function(_super) {
      ...
      GameScene.prototype.onLoad = function() {
        ...
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.UPDATE_WILD_COUNT, function() {
          ...
          _this.SubmitButton.interactable ? _this.SubmitButton.node.getChildByName("Background").getComponent(cc.Sprite).spriteFrame = _this.WildBtn.getSpriteFrame("btn_wild") : _this.SubmitButton.node.getChildByName("Background").getComponent(cc.Sprite).spriteFrame = _this.WildBtn.getSpriteFrame("btn_wildnone");
        }, this);
  ...
  Game: [ function(require, module, exports) {
    ...
    var GameMgr = function() {
      ...
      GameMgr.prototype.addWildCount = function(wild) {
        ...
        EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.UPDATE_WILD_COUNT);
      };
      ...
      GameMgr.prototype.addStreak = function(streak) {
        ...
        this.streakCount >= 4 && exports.Game.addWildCount(1);
  ...
  Poker: [ function(require, module, exports) {
    ...
    var Poker = function(_super) {
      ...
      Poker.prototype.shake = function() {
        if (this.isCycled()) return;
        if ([ "0", "1", "2", "3", "RemoveCardNode", "RemoveCardNodeBust" ].indexOf(this.node.parent.name) >= 0) return;
      ...
      Poker.prototype.onSetParent = function(parent) {
        if ("RemoveCardNode" == parent.name || "RemoveCardNodeBust" == parent.name) this.setComplete(true); else {
  ...
  Result: [ function(require, module, exports) {
    ...
    var Result = function(_super) {
      ...
      Result.prototype.onLoad = function() {
        ...
        this.CardsUsedLabel.string = Game_1.Game.removeCardNode.childrenCount.toString();
