window.__require = function e(t, n, r) {
  ...
  EventName: [ function(require, module, exports) {
    ...
    (function(GlobalEvent) {
      ...
      GlobalEvent[GlobalEvent["PLAY_RECYCLE_POKERS"] = 9] = "PLAY_RECYCLE_POKERS";
      GlobalEvent[GlobalEvent["DEV_POKERS"] = 10] = "DEV_POKERS";
      GlobalEvent[GlobalEvent["PLAY_POKER_PLACE"] = 11] = "PLAY_POKER_PLACE";
      GlobalEvent[GlobalEvent["PLAY_POKER_FLY"] = 12] = "PLAY_POKER_FLY";
      GlobalEvent[GlobalEvent["PLAY_OVER_1"] = 13] = "PLAY_OVER_1";
      GlobalEvent[GlobalEvent["PLAY_OVER_2"] = 14] = "PLAY_OVER_2";
      GlobalEvent[GlobalEvent["PLAY_PAUSE"] = 15] = "PLAY_PAUSE";
      GlobalEvent[GlobalEvent["PLAY_START"] = 16] = "PLAY_START";
      GlobalEvent[GlobalEvent["PLAY_SHAKE"] = 17] = "PLAY_SHAKE";
      GlobalEvent[GlobalEvent["SMALL_BGM"] = 18] = "SMALL_BGM";
      GlobalEvent[GlobalEvent["NORMAL_BGM"] = 19] = "NORMAL_BGM";
      GlobalEvent[GlobalEvent["PLAY_RECYCLE"] = 20] = "PLAY_RECYCLE";
  ...
  GameScene: [ function(require, module, exports) {
    ...
    var GameScene = function(_super) {
      ...
      function GameScene() {
        ...
        _this.TotalRecyclePokerLabel = null;
      ...
      GameScene.prototype.onLoad = function() {
        ...
        this.TotalRecyclePokerLabel.string = Pokers_1.BOOOOM_LIMIT.toString();
        celerx.ready();
      ...
      GameScene.prototype.onPokerClipRemoveChild = function() {
        ...
        0 == this.PokerClip.childrenCount && this.scheduleOnce(function() {
      ...
      __decorate([ property(cc.Label) ], GameScene.prototype, "TotalRecyclePokerLabel", void 0);
  ...
  Game: [ function(require, module, exports) {
    ...
    var GameMgr = function() {
      ...
      GameMgr.prototype.addRemovePokerCount = function(count) {
        this.removePokerCount = exports.Game.removeNode.childrenCount;
  ...
  PokerRoot: [ function(require, module, exports) {
    ...
    var PokerRoot = function(_super) {
      ...
      PokerRoot.prototype.updateTotalValue = function() {
        this.totalValue0 = 0;
        this.totalValue1 = 0;
        var count = 0;
        for (var _i = 0, _a = this.node.children; _i < _a.length; _i++) {
          ...
          } else this.setTotalValue(poker.getValue(), false, false, count);
        }
      ...
      PokerRoot.prototype.setTotalValue = function(value, isWild, isCheck, count) {
        var addScore = 0;
        ...
        } else count >= 5 ? addScore += this.overFive(isCheck) : Game_1.Game.clearStreak();
        if (!isCheck) {
      ...
      PokerRoot.prototype.complete = function(isWild, isCheck) {
        ...
        if (!isCheck) {
          ...
          Game_1.Game.getStreak() >= 2 && Game_1.Game.addScore((Game_1.Game.getStreak() - 1) * Pokers_1.STREAK_SCORE, CMath.ConvertToNodeSpaceAR(this.node, Game_1.Game.removeNode));
        }
        return score;
      };
      ...
      PokerRoot.prototype.flyALLChildren = function(addScore) {
        ...
        for (var _i = 0, children_1 = children; _i < children_1.length; _i++) {
          ...
          var poker = child.getComponent(Poker_1.default);
          poker.autoCompleteDone(.05 * count, parseInt(this.node.name) > 1 ? -1 : 1, count, 0 == addScore);
          count--;
  ...
  Poker: [ function(require, module, exports) {
    ...
    var Poker = function(_super) {
      ...
      Poker.prototype.autoCompleteDone = function(delay, dir, zIndex, isBoom) {
        var _this = this;
